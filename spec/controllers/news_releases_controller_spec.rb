  ...
  shared_examples 'full access to news_releases' do
    describe 'POST #create' do
      ...
      context 'with invalid attributes' do
        it 'does not create the news_release' do
          expect do
            post :create, params: { news_release: attributes_for(:invalid_news_release) }
    ...
    describe 'PATCH #update' do
      ...
      context 'with valid attributes' do
        it 'updates the contact' do
          patch :update, params: { id: news_release, news_release: attributes_for(:news_release,
                                                                                  title: 'title news',
                                                                                  body: 'hogefuga') }
          news_release.reload
      ...
      context 'with invalid attributes' do
        it "dows not change the news_release's attributes" do
          patch :update, params: { id: news_release, news_release: attributes_for(:invalid_news_release) }
          news_release.reload
    ...
    describe 'DELETE #destroy' do
      ...
      it 'deletes the news_release from the database' do
        expect do
          delete :destroy, params: { id: news_release }
        end.to change(NewsRelease, :count).by(-1)
      end
